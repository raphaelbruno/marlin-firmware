...
#define STRING_CONFIG_H_AUTHOR "(Raphael Bruno)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Tevo Tarantula" // will be shown during bootup in line 1
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // TEVO Tarantula
  #define DEFAULT_bedKp 336.57
  #define DEFAULT_bedKi  65.84
  #define DEFAULT_bedKd 430.13 
